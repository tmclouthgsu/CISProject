...
public abstract class BookFlightPane extends VBox {
	...
	protected void init() {
		...
		this.getChildren().add(getBookFlightButton());
		this.getChildren().add(getCancelButton());
		this.getChildren().add(getGotoHomeButton());
	}

	public Button getBookFlightButton() {
		if (cmdBookFlight != null)
			return cmdBookFlight;
		cmdBookFlight = new Button("Book this Flight");
		cmdBookFlight.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent e) {
				BookFlightPane.this.onBookFlight();
			}
		});
		return cmdBookFlight;
	}
	...
	protected abstract void onBookFlight();
